  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        <div>
          ...
          <div className="mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
            <div
              ...
              className="hover:scale:100 origin-center scale-50 opacity-0 transition-all duration-500 ease-in hover:opacity-100"
            >
              <video
        ...
        <div className="full-size absolute left-0 top-0 z-40">
